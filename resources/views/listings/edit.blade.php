...
<x-layout>
    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings/{{ $listing->id }}" enctype="multipart/form-data">
            {{-- We want this to be a 'PUT' request but in the method we can only do GET and POST
            so we use the method directive to indicate PUT --}}
            @csrf
            @method('PUT')
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="location"
                    placeholder="Example: Remote, Dusseldorf NRW, etc" value="{{ $listing->location }}" />
